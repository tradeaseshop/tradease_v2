...
export default function Logo({ size = 'md', showText = true, showTagline = false, layout = 'row' }: LogoProps) {
  const sizeClasses = {
    ...
    xl: { icon: 'w-32 h-32', text: 'text-5xl', tagline: 'text-[11px]' },
  };
  ...
  return (
    <div className="flex flex-col items-center gap-2 font-sans select-none">
      <div className={isStacked ? 'flex flex-col items-center gap-3' : 'flex items-center gap-2.5'}>
        <img
        ...
        />
        {showText && (
          <span className={`${selectedSize.text} font-extrabold tracking-tight leading-none text-center`}>
