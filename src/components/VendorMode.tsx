...
export default function VendorMode({
  ...
  const [ebookWatermark, setEbookWatermark] = useState('Licensed for personal use only');
  ...
  const [ebookEncryptionKey, setEbookEncryptionKey] = useState('TE-PROTECT-8291');
  ...
  const handleCreateProduct = (e: React.FormEvent) => {
    ...
    const newProdItem: Product = {
      ...
      digitalSpecification: pCategory === 'ebooks' ? {
        ...
        encryptionKey: ebookEncryptionKey || 'TE-PROTECT-8291',
    ...
    setTimeout(() => {
      ...
      setEbookWatermark('Licensed for personal use only');
      ...
      setEbookEncryptionKey('TE-PROTECT-8291');
      setEncryptionCompleted(false);
      setEncryptionLog([]);
