...
export const INITIAL_REPORTS: ForumReport[] = [
  {
    ...
    status: "Open",
    date: "2026-06-01",
    description: "The Oraimo FreePods delivered to me on plot 15 Admiralty Way has an audio issue where the left earpiece is completely silent. I have spoken with 'Lagos Gadget Hub' but they requested payment release before offering a replacement."
  },
  {
    id: "rep-2",
    ...
    date: "2026-05-31",
    description: "Our store has shipped and tracking indicates the customer received the suede Chelsea boots 3 days ago. Payment hasn't been released to us yet. Please review and process it to our registered bank account."
  },
  {
    id: "rep-3",
