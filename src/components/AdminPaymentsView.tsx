...
export default function AdminPaymentsView({
  ...
  // Math variables
  const heldBalance = 975000; // TODO: replace with a real computed value once ledger accounting is added
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-405 mt-1">
                  Vendor payouts are sent directly to their registered bank accounts.
                </p>
              </div>
