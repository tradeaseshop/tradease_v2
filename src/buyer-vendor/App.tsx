          ...
          <AnimatePresence mode="wait">
            ...
            {appState === 'splash' && (
              <motion.div
                ...
                className="w-full h-screen flex flex-col overflow-hidden relative bg-slate-950"
              >
            ...
            {appState === 'walkthrough' && (
              <motion.div
                ...
                transition={{ duration: 0.5 }}
                className="w-full h-screen flex flex-col overflow-hidden relative bg-slate-900"
              >
