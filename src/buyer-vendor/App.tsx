...
import MockDeviceContainer from '../components/MockDeviceContainer';
...
export default function App() {
  ...
  // callers in MockDeviceContainer use the return value immediately. The actual
  ...
  return (
    <div className="w-full min-h-screen bg-slate-100 dark:bg-slate-900 overflow-hidden text-gray-800 dark:text-gray-100 transition-colors duration-300 flex flex-col relative select-none">
          ...
          <AnimatePresence mode="wait">
            ...
            {appState === 'splash' && (
              <motion.div
                ...
                className="w-full h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950"
              >
                <div className="w-full max-w-[400px] h-[780px] bg-slate-950 rounded-[45px] p-3 shadow-xl flex flex-col overflow-hidden relative border border-slate-800">
            ...
            {appState === 'walkthrough' && (
              <motion.div
                ...
                className="w-full h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950"
              >
                <div className="w-full max-w-[400px] h-[780px] bg-slate-900 rounded-[45px] p-3 shadow-xl flex flex-col overflow-hidden relative border border-slate-800">
                  <Walkthrough onComplete={() => setAppState('auth')} />
                </div>
              </motion.div>
            )}

            {/* State B.2: Dynamic Login & Social Create Account Gate */}
            {appState === 'auth' && (
              <motion.div
                key="auth-screen"
                initial={{ opacity: 0, scale: 0.96 }}
            ...
            {appState === 'main' && (
              ...
              >
                <MockDeviceContainer
                  ...
                  locationLabel={locationCoordinatesLabel}
