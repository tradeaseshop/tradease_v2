...
export interface Order {
  ...
  quoteShippingCost?: number;
  vendorOrders?: { id:string; vendorId:string; vendorName:string; status:Order['status']; subtotal:number; commissionAmount:number; vendorEarnings:number; deliveryStatus:string; createdAt:string; updatedAt:string }[];
}
