...
export default function AdminApp() {
  const [adminSession, setAdminSession] = useState<{ id: string; name: string; level: string; email?: string; phone?: string; avatar?: string; totpEnabled?: boolean } | null>(null);
  ...
  const handleUpdateAdminSession = (newSession: Partial<{ id: string; name: string; level: string; email?: string; phone?: string; avatar?: string; totpEnabled?: boolean }>) => {
    setAdminSession((prev) => (prev ? { ...prev, ...newSession } : (newSession as any)));
  };
