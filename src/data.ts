...
export const DEFAULT_LOGISTICS_PROVIDERS: LogisticsProvider[] = [
  {
    ...
    apiKey: 'dl_live_99201923810293',
    webhookUrl: 'https://tradeease.ng/api/webhooks/deliveri',
    webhookSecret: 'whsec_deliveri_secret_key_88192',
    baseFee: 1500,
    perKmRate: 150,
    estimatedDays: '1 - 2 Days',
    badge: 'LOCAL STATE HUBS',
    description: 'Sister-carrier door-to-door transit & state bus terminals dispatch with built-in escrow receipt confirmation.',
    rating: 4.8,
    supportedServices: ['Same-Day Terminal Pickup', 'Doorstep Inter-State', 'Escrow Verification', 'Rider Live GPS'],
  ...
  },
  {
    ...
    apiKey: 'ups_live_ak882019203910',
    webhookUrl: 'https://tradeease.ng/api/webhooks/ups',
    webhookSecret: 'whsec_ups_882019382',
    baseFee: 3500,
    perKmRate: 200,
  ...
  },
  {
    ...
    apiKey: 'dhl_live_7720193820192',
    webhookUrl: 'https://tradeease.ng/api/webhooks/dhl',
    webhookSecret: 'whsec_dhl_772019382',
    baseFee: 4200,
    perKmRate: 250,
  ...
  },
  {
    ...
    apiKey: 'fdx_live_5510293849102',
    webhookUrl: 'https://tradeease.ng/api/webhooks/fedex',
    webhookSecret: 'whsec_fedex_5510293',
    baseFee: 3800,
    perKmRate: 220,
    estimatedDays: '1 - 2 Days',
    badge: 'AIR CARGO',
  ...
  },
  {
    ...
    apiKey: 'gig_live_33910293841',
    webhookUrl: 'https://tradeease.ng/api/webhooks/gig',
    webhookSecret: 'whsec_gig_3391029',
    baseFee: 1800,
    perKmRate: 160,
  ...
  },
  {
    ...
    apiKey: 'rs_live_44910293810',
    webhookUrl: 'https://tradeease.ng/api/webhooks/redstar',
    webhookSecret: 'whsec_redstar_4491029',
    baseFee: 2000,
    perKmRate: 170,
    estimatedDays: '2 - 3 Days',
